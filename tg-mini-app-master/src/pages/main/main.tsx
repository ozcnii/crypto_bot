...
export const Main = () => {
  ...
  useEffect(() => {
    const updateHeight = () => {
      ...
      setWrapperHeight(`calc(var(--tg-viewport-height) - ${headerHeight + footerHeight + 105}px)`);
    }
    ...
    <div className={css.main}>
      <div className={css.header}>
        ...
        <div className={css.listWrapper}>
          ...
          <button className={css.plusButton} type="button">+</button>
        </div>
      </div>
      <div className={`${css.coinsWrapper} ${loading ? css.loading : ''}`}>
        <CoinsSwiper />
      </div>
      <div className={css.footer}>
        ...
        <div className={css.footerList}>
          <Link to="/fellows">
            <div className={`${css.fellows} ${location.pathname === '/fellows' ? css.active : ''}`}>
              <img src="img/fellows.png" alt="fellows" className={css.fellowsImg} />
              <p className={css.fellowsText}>Fellows</p>
            </div>
          </Link>
          <Link to="/tasks">
            <div className={`${css.build} ${location.pathname === '/' ? css.active : ''}`}>
              <img src="build.png" alt="build" className={css.buildImg} />
              <p className={css.buildText}>Build</p>
            </div>
          </Link>
          <Link to="/boost">
            <div className={`${css.boost} ${location.pathname === '/boost' ? css.active : ''}`}>
