...
export const Clans = () => {
	...
	const { clans, clan, loading } = useSelector((state: RootState) => state.clans)
	...
	return (
		<div className={css.main}>
			...
			{clan.owner_id !== user.id && (
				<button type='button' className={css.floatingButton} onClick={handleOnClick}>Create your clan</button>
			)}
			<Modal />
		</div>
	)
