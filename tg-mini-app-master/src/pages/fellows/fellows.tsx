...
export const Fellows = () => {
  ...
  const hanldleOnShareClick = () => {
    utils.shareURL(
      `https://t.me/aenolabsbot?start=${user?.referral_code}`,
      'Hello from Aeno Labs! 👋! Go through my link!',
    );
  };
  ...
  return (
    <div className={css.main}>
      ...
      <div className={css.fellowsListWrapper}>
        ...
        {referrals?.length > 0 ? (
          <InvitedFriendsSwiper friends={referrals} />
        ) : (
